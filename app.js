...
var WEBHOOK_CSF  = 'https://hook.us2.make.com/mx2bsx1rtxf0n619c9w91sqy7d49gb19';
    ...
    .then(function(d) {
      ...
      if (d.regimen_codigo) {
        ...
        for (var i = 0; i < sel.options.length; i++) {
          if (sel.options[i].value === d.regimen_codigo || sel.options[i].value === d.regimen_codigo + 'pm') {
